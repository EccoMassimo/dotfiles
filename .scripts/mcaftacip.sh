...
if echo "$programs" | grep '0' >/dev/null 2>&1; then
	...
	sudo apt install cowsay cmatrix libreoffice audacity irssi lynx htop neofetch ttf-mscorefonts-installer steam lolcat figlet screenkey obs-studio youtube-dl lutris gimp
	fi
